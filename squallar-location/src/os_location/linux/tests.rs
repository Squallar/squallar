...
fn decode_wire(latitude: f64, longitude: f64, altitude: f64, speed: f64, heading: f64) -> Location {
    ...
    let body = (
        ObjectPath::try_from("/org/freedesktop/portal/desktop/session/1_1/squallar")
...
/// check.
const DESKTOP_ENTRY: &str = include_str!("../../../../packaging/linux/app.squallar.desktop");
