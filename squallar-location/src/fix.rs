...
pub struct Fix {
    ...
    pub point: squallar_geo::GeoPoint,
...
// `squallar_geo::GeoPoint` does not derive `Default` — a (0, 0) point is a place,
// not an absence.
impl Default for Fix {
    fn default() -> Self {
        Self {
            point: squallar_geo::GeoPoint { lat: 0.0, lon: 0.0 },
            altitude_m: None,
            speed_mps: None,
            heading_deg: None,
            satellites: None,
...
/// their weather. A portal IP lookup — the coarsest source squallar reads —
