//! The one thing that decides whether squallar asks the OS where the user is.
...
/// What squallar remembers about location across restarts.
...
struct LocationMemo {
    ...
    attempts: u8,
    /// squallar's own switch, distinct from the permission.
    enabled: bool,
}
