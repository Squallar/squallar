 ...
 * `squallar_location::android::init`; the poll and the start/stop calls live in
 * squallar-location/src/android/location.rs.
 *
 ...
 * squallar-location for why this shape was chosen over the alternatives.
 *
