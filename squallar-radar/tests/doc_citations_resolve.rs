...
const ALLOWED: &[(&str, &str, &str)] = &[
    ...
    (
        "squallar-app/src/app_render/loop_overlay_render_tests.rs",
    ...
    (
        "squallar-overlays/src/glm/fetch/tests.rs",
    ...
    (
        "squallar-gpu/tests/floor_alignment.rs",
    ...
    (
        "squallar-egui/src/ui_map/volume_arm_tests.rs",
    ...
    (
        "squallar-overlays/src/hrrr/fields/tests.rs",
        ...
        "The successor is `the_three_reflectivity_ladders_agree`, three lines \
         ...
         was the wrong number: a third dBZ ladder in `squallar-radar` had \
    ...
    (
        "squallar-egui/src/ui_config/fixture_tests.rs",
...
fn a_citation_to_an_ignored_test_says_that_it_is_ignored() {
    ...
    assert!(
        ...
        "{} comment(s) cite a test that does not run by default, without saying so:\n\n{}\n\n\
         ...
         `cargo test -p squallar-gpu --test volume_gpu -- --ignored`\". Do **not** \
