...
fn the_readout_door_prints_exactly_what_the_enum_method_prints() {
    let imperial = squallar_units::UserPreferences::default();
    let metric = squallar_units::UserPreferences {
        speed: squallar_units::SpeedUnit::MetersPerSec,
        height: squallar_units::HeightUnit::Meters,
        precip_rate: squallar_units::PrecipRateUnit::MillimetersPerHour,
        hail_size: squallar_units::HailSizeUnit::Centimeters,
