...
//! +mutable-globals` with `-Zbuild-std`, and `squallar-web` fills the pool with
...
//! same `par_iter`: `squallar_web::rayon_pool::install_serial_pool` hands it a
