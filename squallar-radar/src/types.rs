...
use squallar_geo::{KM_PER_DEGREE_LAT, lat_rad_to_mercator_y};
use squallar_units::{Quantity, UserPreferences};
...
impl ImageBounds {
    ...
    ///
    /// On [`KM_PER_DEGREE_LAT`], which is [`squallar_geo::EARTH_RADIUS_KM`]
    /// — the same
...
impl From<ImageBounds> for squallar_geo::GeoBounds {
...
impl From<ImageBounds> for squallar_geo::PlacedRaster {
    fn from(bounds: ImageBounds) -> Self {
        squallar_geo::PlacedRaster::of(bounds.into())
    }
}
