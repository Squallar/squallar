...
pub use squallar_source::product::{FieldId as Id, ProductSpec as Spec};
...
pub fn format_value(
    id: &FieldId,
    value: f32,
    prefs: &squallar_units::UserPreferences,
) -> Option<String> {
...
///
/// The exact model of [`squallar_source::id::known`], and for the same reason:
