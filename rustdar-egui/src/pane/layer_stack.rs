...
//!
//! [`OverlayRegistry`](rustdar_overlays::render::overlay_state::OverlayRegistry)
...
//! only ever grows ([`LAYER_ID_LEDGER`](rustdar_source::id::LAYER_ID_LEDGER) is
...
impl LayerStack {
    ...
    /// autosave".
    ///
    /// [`default_enabled`]: rustdar_source::handler::SourceHandler::default_enabled
