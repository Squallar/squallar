...
use squallar_egui::pane::{LayerTimeState, PaneState};
...
fn site() -> squallar_radar::sites::RadarSite {
...
/// reads.
fn pane_animating(extra: &[squallar_source::id::LayerId]) -> PaneState {
    ...
    *pane.time_state_mut(&known::RADAR) = squallar_egui::radar_layer::begin_loop(
    ...
    for id in extra {
        ...
        timeline.phase = squallar_egui::pane::LoopPhase::Rendering;
