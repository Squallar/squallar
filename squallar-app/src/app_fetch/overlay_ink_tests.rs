...
//! for the premultiply, and `OverlayPicture` is what carries the answer
//! across.
//!
...
//! Neither can be satisfied by the fixture stating its own answer — both drive
//! the real `App::overlay_job_deliver` over real rasterizer bytes and read the
//! variant off what it built.
...
/// one the production closure wrote.
