...
fn dummy_plan_view(ctx: &egui::Context) -> RadarImageData {
    ...
    RadarImageData {
        ...
        lon: 0.0,
        max_range_km: 100.0,
        placed: squallar_radar::types::ImageBounds::from_radar_site(0.0, 0.0, 100.0).into(),
        nyquist_ms: None,
...
fn classification_pane(
    ctx: &egui::Context,
    source: Option<squallar_radar::hca::MeltingLayerSource>,
) -> PaneState {
    pane_showing_render(
        ctx,
        &radar_fields::known::HYDROMETEOR_CLASSIFICATION,
...
fn storm_relative_pane(
    ctx: &egui::Context,
    source: Option<squallar_radar::srv::StormMotionSource>,
) -> PaneState {
    pane_showing_render(
        ctx,
...
fn a_storm_relative_pane_reports_the_vector_its_pixels_were_shifted_by() {
    ...
    assert_eq!(
        classification_pane(
            &ctx,
            Some(squallar_radar::hca::MeltingLayerSource::FleetDefault)
        )
