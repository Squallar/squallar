...
use squallar_radar::hover::HoverSource;
use squallar_radar::types::{RenderView, ScanInfo};
...
pub use content::{
    ...
    box_size_km_for_base, box_size_km_in, resolution_km, volume_base_km_msl,
};
...
pub struct RadarImageData {
    ...
    pub placed: squallar_geo::PlacedRaster,
...
pub struct SectionImageData {
    pub texture: egui::TextureHandle,
    pub axes: squallar_radar::xsect::SectionAxes,
    ...
    /// [`squallar_radar::sampler::ladder_fingerprint`].
    pub ladder: u64,
}
...
pub enum LoopFrameImage {
    ...
    ///
    /// It carries its own [`PlacedRaster`](squallar_geo::PlacedRaster), so the
...
///
/// The one spelling of the quantum. `squallar-app`'s render-key builder calls
...
pub struct LayerTimeState {
    ...
    /// [`squallar_radar::loop_geometry::LoopGeometry`] in it; read it back with
    /// [`Self::anchor_as`].
    pub anchor: Option<squallar_source::handler::FetchPayload>,
...
pub enum TimeMode {
    ...
    /// it; an [`squallar_source::time::TimeAxis::EventLifetime`] layer shows
...
/// [`SourceHandler::as_of_quantum`](squallar_source::handler::SourceHandler::as_of_quantum)
...
pub struct LayerSlot {
    ...
    pub state: Option<squallar_source::handler::FetchPayload>,
...
impl LayerTimeState {
    ...
    pub fn begin(
        span_secs: u64,
        view: RenderView,
        anchor: squallar_source::handler::FetchPayload,
    ) -> Self {
        Self {
    ...
    ///
    /// This is `squallar_source::time::TimeAxis::FrameSeries`'s rule verbatim,
...
impl PaneState {
    ...
    pub fn render_view(&self) -> squallar_radar::types::RenderView {
        self.content.render_view()
    }

    /// Whether this pane is drawing the plan view every pane used to be.
    pub fn is_map(&self) -> bool {
        self.render_view() == squallar_radar::types::RenderView::PlanView
    }
    ...
    pub fn draws_ground(&self) -> bool {
        match self.render_view() {
            squallar_radar::types::RenderView::PlanView => true,
            ...
            squallar_radar::types::RenderView::CrossSection => false,
        }
    }
    ...
    pub fn draws_map_layers(&self) -> bool {
        self.render_view() != squallar_radar::types::RenderView::CrossSection
    }
    ...
    /// mode that takes.
    pub fn set_view(&mut self, view: squallar_radar::types::RenderView) {
    ...
    /// `squallar_radar::nyquist`), so past ±Vny the sign wraps. A TDWR always
    ...
    pub fn displayed_melting_layer_source(
        &self,
    ) -> Option<squallar_radar::hca::MeltingLayerSource> {
    ...
    pub fn displayed_storm_motion(&self) -> Option<squallar_radar::srv::SrvMotion> {
    ...
    ///
    /// Only a [`squallar_source::time::TimeAxis::FrameSeries`] layer can hold
    ...
    pub fn set_layer_enabled(
        &mut self,
        registry: &mut squallar_overlays::render::overlay_state::OverlayRegistry,
        pane_idx: usize,
        id: &LayerId,
        enabled: bool,
    ) {
