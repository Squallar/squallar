            ...
            MenuNode::Submenu {
                ...
                children: vec![
                    ...
                    MenuNode::Toggle {
                        ...
                        value: pane.render_view() == squallar_radar::types::RenderView::Volume,
                    },
...
mod tests {
    ...
    fn the_volume_toggle_converts_in_both_directions() {
        ...
        assert_eq!(
            gui.pending_pane_view_for_test(),
            Some((0, squallar_radar::types::RenderView::PlanView)),
    ...
    /// click. The concrete items are `pub(crate)` to `squallar-overlays`; the
    /// trait is not.
    #[derive(Debug)]
    struct StubOverlayItem;

    impl squallar_overlays::render::overlay_state::OverlayItem for StubOverlayItem {
        ...
        fn matches(
            &self,
            _other: &dyn squallar_overlays::render::overlay_state::OverlayItem,
        ) -> bool {
            false
        }
