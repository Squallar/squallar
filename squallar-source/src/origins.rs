//! Every network origin squallar reads from, declared in one place.
//!
...
/// The set of network origins squallar reads from. Construct with
...
pub struct DataSources {
    ...
    /// −20 °C levels) per radar site. See `squallar_radar::sounding`.
...
impl DataSources {
    ...
    ///
    /// The key is interpolated, not encoded: every key squallar builds is drawn from
    /// `[A-Za-z0-9_./-]`.
    ...
    /// what `squallar_radar::sounding::parse_env_heights` interpolates the −20 °C
