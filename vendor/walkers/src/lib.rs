...
#[cfg(feature = "mvt")]
pub use text::{AtlasStamp, BUCKET_POINTS, GalleyCache, OccupiedAreas, Text, intersect_tests};
...
#[cfg(feature = "mvt")]
pub use mvt::{
    FeatureGeometry, Geometry, PolygonTessellator, ShapeOrText, render_line, tessellate_polygon,
};
