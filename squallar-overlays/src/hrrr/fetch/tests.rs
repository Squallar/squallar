...
/// rather than of squallar's code: the `(var, level, forecast)` triple
...
///
/// `cargo test -p squallar-overlays -- --ignored --nocapture live_every_parameter`
#[tokio::test]
...
///
/// `cargo test -p squallar-overlays -- --ignored --nocapture live_hrrr`
#[tokio::test]
#[ignore = "hits the live noaa-hrrr-bdp-pds S3 bucket"]
