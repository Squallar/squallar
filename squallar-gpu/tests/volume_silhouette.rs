...
//!
//! ```text
//! cargo test -p squallar-gpu --test volume_silhouette -- --ignored --nocapture
//! ```
//!
...
fn device() -> (wgpu::Device, wgpu::Queue) {
    ...
    pollster::block_on(adapter.request_device(&wgpu::DeviceDescriptor {
        label: Some("squallar.volume.silhouette.device"),
...
fn read_back(
    ...
    let staging = device.create_buffer(&wgpu::BufferDescriptor {
        label: Some("squallar.volume.silhouette.readback"),
