...
//!
//! `squallar_radar::par` is rayon on every target as of WS3b, so *something* has
...
pub fn threads() -> usize {
    ...
    reported.clamp(
        1,
        squallar_device_profile::constants::WASM_MAX_RAYON_THREADS,
    )
}
...
#[wasm_bindgen(js_name = squallarRayonSerialPool)]
