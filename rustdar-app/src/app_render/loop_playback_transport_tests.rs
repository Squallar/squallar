...
use rustdar_egui::pane::{LayerTimeState, LoopFrame, LoopPhase, TimeMode};
use rustdar_source::id::known;
use rustdar_source::time::FrameStamp;
...
fn textured_frames(ctx: &egui::Context, stamps: &[chrono::NaiveDateTime]) -> Vec<LoopFrame> {
    stamps
        ...
        .map(|&timestamp| LoopFrame {
            timestamp,
            image: Some(rustdar_egui::pane::LoopFrameImage::Overlay(
